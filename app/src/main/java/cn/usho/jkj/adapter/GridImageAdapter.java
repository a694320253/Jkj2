...
public class GridImageAdapter extends
    ...
    private List<TestLocalMedia> sxList;

    public void setSxList(List<TestLocalMedia> sxList) {
        this.sxList = sxList;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                ...
                viewHolder.time.setText("拍摄时间"+sxList.get(position).getDatetime()+"\n"+
                "latValue "+sxList.get(position).getLatValue()+"\n"+
                "lngValue "+sxList.get(position).getLngValue());
            }
            //itemView 的点击事件
